...
PTG::PTG(ros::NodeHandle& nh) :
    ...
    //AirSim
    sub_to_airSim_gate = nh.subscribe("gate_poses", 10, &PTG::gateCallback, this);
    sub_to_airSim_state = nh.subscribe("state", 10, &PTG::stateCallback, this);
